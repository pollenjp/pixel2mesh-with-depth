...
class P2MModelModule(pl.LightningModule):
    ...
    def test_step_debug(self, batch: P2MBatchData, batch_idx: int, preds: P2MModelForwardReturn):
        # save predicted data
    ...
    def custom_batch_log(
        ...
        batch_size = min(self.options.batch_size_for_plot, len(batch["images"]))
